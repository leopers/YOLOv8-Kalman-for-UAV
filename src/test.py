import cv2
from classicaldetector import detect
from Kalman import KalmanFilter

def main():

    # Create opencv video capture object
    VideoCap = cv2.VideoCapture('/Users/leonardodias/Desktop/Graduação ITA/Exame CM/Exame-CM203/utils/randomball.avi')
